...
import time
raiden = raiden.Raiden(mhz=100, serial_dev="/dev/raiden", baud= 115200, ticks= True) 
...
while True:	   
    ...
    raiden.set_param(param="CMD_GLITCH_WIDTH", value= 1000)
    raiden.set_param(param="CMD_GLITCH_GAP", value= 5)
    raiden.set_param(param="CMD_GLITCH_COUNT", value= 1)
    raiden.set_param(param="CMD_UART_TRIGGER", value= 0x0D)
